...
class MapViewController: UIViewController {
    ...
    func showMessage(type: MapMessage) {
        let title = type == .authorizationWarning ? "Aviso" : "Erro"
        let message = type == .authorizationWarning ? "Para usar os recursos de localizaçao do app, voce precisa permitir o uso na tela de ajustes" : "Nao foi possivel encontrar esta rota"
        ...
        directions.calculate { (response, error) in
            if error == nil {
                if let response = response {
                    ...
                    //overlay e a camada do caminho da rota
